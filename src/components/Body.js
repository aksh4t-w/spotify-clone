...
const Body = () => {
    ...
    const fetchWeeklyPlaylist = (playlists) => {
    ...
    useEffect(()=>{
        const weeklyPlaylistId = fetchWeeklyPlaylist(playlists)?.id
        
        spotifyApi.getPlaylist(weeklyPlaylistId).then(tracks =>
            setDiscoverWeekly(tracks)
        )
    }, [playlists])
        ...
        <div className="body">
            ...
            <div className="body__songs">
                <div className="body__icons">
                    <PlayCircleFilledOutlinedIcon className="body__play"/>
